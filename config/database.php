...
return [
    ...
    'connections' => [
        ...
        'wms' => [
            ...
            // 数据库名
            'database' => Env::get('database.database', 'loop_wms'),
            // 用户名
            'username' => Env::get('database.username', 'root'),
            // 密码
            'password' => Env::get('database.password', '123456'),
            // 端口
            'hostport' => Env::get('database.hostport', '3301'),
            // 数据库连接参数
            'params' => [],
            // 数据库编码默认采用utf8
            'charset' => Env::get('database.charset', 'utf8'),
            // 数据库表前缀
            'prefix' => Env::get('database.prefix', 'wms_'),
        ...
        'account' => [
            ...
            'password' => Env::get('database.password', '123456'),
            // 端口
            'hostport' => Env::get('database.hostport', '3300'),
            // 数据库连接参数
            'params' => [],
            // 数据库编码默认采用utf8
            'charset' => Env::get('database.charset', 'utf8'),
